...
var NgClickOutsideExcludeDirective = class _NgClickOutsideExcludeDirective extends NgClickOutsideExcludeToken {
  constructor() {
    super(...arguments);
...
var NgClickOutsideDirective = class _NgClickOutsideDirective {
  constructor() {
...
var NgClickOutsideAttachOutsideDirective = class _NgClickOutsideAttachOutsideDirective extends NgClickOutsideDirective {
  constructor() {
    super();
  ...
  static {
    this.ɵfac = function NgClickOutsideAttachOutsideDirective_Factory(__ngFactoryType__) {
...
var NgClickOutsideDelayOutsideDirective = class _NgClickOutsideDelayOutsideDirective extends NgClickOutsideDirective {
  constructor() {
    super(...arguments);
...
var NgClickOutsideEmitOnBlurDirective = class _NgClickOutsideEmitOnBlurDirective {
  constructor() {
    this._ngZone = inject(NgZone);
    this.document = inject(DOCUMENT);
  ...
  static {
    this.ɵfac = function NgClickOutsideEmitOnBlurDirective_Factory(__ngFactoryType__) {
